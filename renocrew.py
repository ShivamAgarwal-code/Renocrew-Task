...
class Restaurant:
    def __init__(self, name, cuisine, rating, proximity):
        # Initialize a Restaurant object with name, cuisine, rating, and proximity attributes
        self.name = name
...
def populate_data_structure():
    ...
    restaurants = [
        ...
        Restaurant("Restaurant6", "Punjabi", 4.6, 2),  # Corrected spelling
...
if __name__ == "__main__":
    ...
    assert recommend_restaurants("Punjabi", test_restaurant_data)  # Corrected cuisine name
